 ...
 const Apps = () => {
     ...
     async function news(){
         let res=await fetch("https://newsapi.org/v2/everything?q=today&pageSize=20&sortBy=popularity&apiKey=00451f2d4a81423db8eab6400f984f89");
   ...
   <>
      <Navbar/>
       <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-3 gap-5">{value}</div>
   </>
